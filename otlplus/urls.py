...
urlpatterns = [
    ...
    url(r"^api/users/(?P<user_id>\d+)/planners/(?P<planner_id>\d+)/planner-item/(?P<planner_item_id>\d+)$",
        planner_views.UserInstancePlannerInstancePlannerItemView.as_view()),
    url(r"^api/users/(?P<user_id>\d+)/planners/(?P<planner_id>\d+)/add-planner-item$",
