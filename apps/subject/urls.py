...
urlpatterns = [
    ...
    url(r'^lectures/(?P<lecture_id>\d+)/comments$', views.lectures_intance_comments_view),
    url(r'^lectures/(?P<lecture_id>\d+)/related-comments$', views.lectures_intance_related_comments_view),
]
