...
class ResearchLecture(models.Model):
    ...
    professor = models.ManyToManyField(Professor, related_name='related_lecture_professor', blank=True)
    is_english = models.BooleanField()
    deleted = models.BooleanField(default=False)

    course = models.ForeignKey(Course, related_name='related_lecture_course')
